    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden hover:border-zinc-700 transition-all group">
      ...
      <div className="p-5">
        ...
        <a
          ...
          className="text-xs text-[#E8922A] hover:underline flex items-center gap-1 mb-3 truncate"
        >
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <a
            href="/github-import"
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold transition-all hover:opacity-90 border border-zinc-700 text-zinc-300 hover:border-zinc-500"
          >
